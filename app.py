...
if not st.session_state['logged_in']:
    ...
    st.sidebar.success(f"Logado como: Equipe Técnica")
...
# Se não estiver logado, mostra apenas o formulário de reporte
if not st.session_state['logged_in']:
    ...
    with st.form("form_aluno", clear_on_submit=True):
        ...
        with col1:
            curso = st.selectbox("Seu Curso", ["Odontologia", "Fisioterapia", "Nutrição", "Psicologia", 
        ...
        with col2:
            tipo = st.selectbox("Tipo de Problema", ["Elétrica", "Hidráulica", "Manutenção Preventiva", 
...
# --- VISÃO DA EQUIPE TÉCNICA (SOMENTE SE LOGADO) ---
else:
